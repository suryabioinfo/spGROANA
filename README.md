...
Delta-Z Analysis for Peptide–Membrane Systems This Python script performs batch Δz analysis between peptide COM and lipid headgroup COM from GROMACS .xvg files.
